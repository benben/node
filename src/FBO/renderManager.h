...
class renderManager {
    ...
    public:
        ...
        void setLeftWarp(int whichScreen, float centerPointPct, float startWarp, float endWarp);
        void setRightWarp(int whichScreen, float centerPointPct, float startWarp, float endWarp);
